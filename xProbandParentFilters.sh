...
CMD="$FiltScrDir/ExmFilt.CustomGenotype_NewAnn.py -v $VcfFil -o $FamNam.AR --alt $Proband --het $Parent -P"
echo $CMD
eval $CMD
#Autosomal Dominant
echo "Autosomal Dominant.."
CMD="$FiltScrDir/ExmFilt.CustomGenotype_NewAnn.py -v $VcfFil -o $FamNam.AD  --het $Proband --ref $Parent -P"
echo $CMD
eval $CMD
#compound heterozygous
echo "Compund heterozygous.."
CMD="$FiltScrDir/ExmFilt.CustomGenotype_NewAnn.py -v $VcfFil -o $FamNam.tempheppat  --het $Proband,$Parent -p"
echo $CMD
eval $CMD
CMD="$FiltScrDir/ExmFilt.CustomGenotype_NewAnn.py -v $VcfFil -o $FamNam.temphepmat  --het $Proband --ref $Parent -p"
echo $CMD
eval $CMD
R --vanilla <<RSCRIPT
